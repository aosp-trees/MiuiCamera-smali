...
.method public static constructor <clinit>()V
    ...
    sput-object v7, Ld/o/b/d/c;->e:Ljava/util/concurrent/BlockingQueue;

    const v1, 0x7fffffff

    sput v1, Ld/o/b/d/c;->f:I

    const/4 v1, 0x0

    sput-boolean v1, Ld/o/b/d/c;->g:Z

    new-instance v9, Ljava/util/concurrent/ThreadPoolExecutor;

    sget-object v15, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    new-instance v8, Ld/o/b/d/e;

    const-string v1, "GlobalThread-core"

    const/4 v10, 0x5

    invoke-direct {v8, v1, v10}, Ld/o/b/d/e;-><init>(Ljava/lang/String;I)V
    ...
    sput-object v9, Ld/o/b/d/c;->a:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v3, Ld/o/b/d/e;

    const-string v4, "GlobalThread-delay"

    invoke-direct {v3, v4, v10}, Ld/o/b/d/e;-><init>(Ljava/lang/String;I)V

    const/4 v4, 0x2

    invoke-direct {v2, v4, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v2, Ld/o/b/d/c;->b:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const-wide/16 v3, 0xa

    invoke-virtual {v2, v3, v4, v15}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setKeepAliveTime(JLjava/util/concurrent/TimeUnit;)V

    sget-object v2, Ld/o/b/d/c;->b:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    new-instance v0, Ld/o/b/d/e;

    const-string v4, "GlobalThread-log_upload"

    invoke-direct {v0, v4, v1}, Ld/o/b/d/e;-><init>(Ljava/lang/String;I)V
    ...
    sput-object v2, Ld/o/b/d/c;->c:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static a(Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
    ...
    sget-boolean v0, Ld/o/b/d/c;->g:Z
    ...
    sget v0, Ld/o/b/d/c;->f:I

    const/16 v4, 0x15

    if-lt v0, v4, :cond_0

    sget-object v0, Ld/o/b/d/c;->b:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v4, 0x1

    invoke-virtual {v0, v4}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    sput-boolean v4, Ld/o/b/d/c;->g:Z
    ...
    :goto_0
    invoke-static {v3, p0, v2}, Ld/o/b/g/a;->i(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public static b(I)V
    ...
    sput p0, Ld/o/b/d/c;->f:I

    :cond_0
    sget p0, Ld/o/b/d/c;->f:I

    const/16 v0, 0x15

    if-lt p0, v0, :cond_1

    sget-object p0, Ld/o/b/d/c;->b:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public static c(Ljava/util/concurrent/ScheduledFuture;)V
    ...
    const-string v0, "GlobalThread"

    const-string v1, "removeCallBacks error,empty future"

    invoke-static {v0, v1, p0}, Ld/o/b/g/a;->f(Ljava/lang/String;Ljava/lang/String;Z)V
