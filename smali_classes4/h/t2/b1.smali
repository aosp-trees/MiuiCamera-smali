...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lh/t2/a1;-><init>()V
...
.method public static final d(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    check-cast p0, Lh/t2/w1/d;

    invoke-virtual {p0}, Lh/t2/w1/d;->i()Ljava/util/Map;
...
.method private static final e(ILh/d3/w/l;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    invoke-static {p0}, Lh/t2/b1;->h(I)Ljava/util/Map;

    move-result-object p0

    invoke-interface {p1, p0}, Lh/d3/w/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lh/t2/b1;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method private static final f(Lh/d3/w/l;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    invoke-static {}, Lh/t2/b1;->g()Ljava/util/Map;

    move-result-object v0

    invoke-interface {p0, v0}, Lh/d3/w/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lh/t2/b1;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final g()Ljava/util/Map;
    ...
    .line 1
    new-instance v0, Lh/t2/w1/d;

    invoke-direct {v0}, Lh/t2/w1/d;-><init>()V
...
.method public static final h(I)Ljava/util/Map;
    ...
    invoke-direct {v0, p0}, Lh/t2/w1/d;-><init>(I)V

    return-object v0
.end method

.method public static final i(Ljava/util/concurrent/ConcurrentMap;Ljava/lang/Object;Lh/d3/w/a;)Ljava/lang/Object;
    .locals 1
...
.method public static final k(Lh/u0;)Ljava/util/Map;
    .locals 1
    .param p0    # Lh/u0;
        .annotation build Ln/d/a/d;
        .end annotation
...
.method public static final varargs l(Ljava/util/Comparator;[Lh/u0;)Ljava/util/SortedMap;
    .locals 1
    ...
    invoke-static {v0, p1}, Lh/t2/c1;->y0(Ljava/util/Map;[Lh/u0;)V

    return-object v0
.end method

.method public static final varargs m([Lh/u0;)Ljava/util/SortedMap;
    .locals 1
    .param p0    # [Lh/u0;
        .annotation build Ln/d/a/d;
        .end annotation
    ...
    invoke-static {v0, p0}, Lh/t2/c1;->y0(Ljava/util/Map;[Lh/u0;)V
...
.method private static final p(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p0}, Lh/t2/b1;->o(Ljava/util/Map;)Ljava/util/Map;
