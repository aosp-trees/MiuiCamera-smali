...
# virtual methods
.method public checkTerminated(ZZZLn/e/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p0}, Ln/e/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 10
    invoke-interface {p4, p1}, Ln/e/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    .line 11
    :cond_2
    invoke-interface {p4}, Ln/e/c;->onComplete()V
...
.method public drain()V
    ...
    .line 4
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Ln/e/c;)V

    goto :goto_1

    .line 5
    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Ln/e/c;)V
...
.method public drainFused(Ln/e/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 11
    :cond_2
    invoke-interface {p1, v4}, Ln/e/c;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Ln/e/c;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLn/e/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    .line 7
    invoke-interface {v5, v8}, Ln/e/c;->onNext(Ljava/lang/Object;)V
