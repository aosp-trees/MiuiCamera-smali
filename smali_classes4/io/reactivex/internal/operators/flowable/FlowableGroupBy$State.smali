...
.method public drainNormal()V
    ...
    .line 7
    :goto_2
    invoke-virtual {p0, v12, v14, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLn/e/c;Z)Z
    ...
    .line 8
    :cond_3
    invoke-interface {v2, v13}, Ln/e/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v11, v12, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLn/e/c;Z)Z
    ...
    iget-object v5, v5, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Ln/e/d;

    invoke-interface {v5, v9, v10}, Ln/e/d;->request(J)V
