...
.method private jarDir(Ljava/io/File;Ljava/util/jar/JarOutputStream;Ljava/lang/String;)V
    ...
    invoke-virtual {p3, v3, v4}, Ljava/util/jar/JarEntry;->setTime(J)V

    .line 17
    invoke-virtual {p2, p3}, Ljava/util/jar/JarOutputStream;->putNextEntry(Ljava/util/zip/ZipEntry;)V

    .line 18
    invoke-virtual {p2}, Ljava/util/jar/JarOutputStream;->flush()V

    .line 19
    invoke-virtual {p2}, Ljava/util/jar/JarOutputStream;->closeEntry()V
    ...
    invoke-virtual {v2, v3, v4}, Ljava/util/jar/JarEntry;->setTime(J)V
    ...
    invoke-virtual {p2, p3, v1, p1}, Ljava/util/jar/JarOutputStream;->write([BII)V
