...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    .line 12
    invoke-static {}, Lr/d$a;->a()Lr/d;

    move-result-object v2

    .line 13
    invoke-interface {v2}, Lr/d;->Al()Lr/j;
    ...
    .line 14
    invoke-interface {v3, v4}, Lr/j;->setId(Ljava/lang/String;)V

    const-string v4, "1600,21600"

    .line 15
    invoke-interface {v3, v4}, Lr/j;->n6(Ljava/lang/String;)V

    const/high16 v4, 0x43080000    # 136.0f

    .line 16
    invoke-interface {v3, v4}, Lr/j;->i8(F)V

    const-string v4, "10800"

    .line 17
    invoke-interface {v3, v4}, Lr/j;->v8(Ljava/lang/String;)V

    const-string v4, "m@7,0l@8,0m@5,21600l@6,21600e"

    .line 18
    invoke-interface {v3, v4}, Lr/j;->E8(Ljava/lang/String;)V

    .line 19
    invoke-interface {v3}, Lr/j;->n1()Lr/c;

    move-result-object v4

    .line 20
    invoke-interface {v4}, Lr/c;->addNewF()Lr/a;

    move-result-object v5

    const-string v6, "sum #0 0 10800"

    invoke-interface {v5, v6}, Lr/a;->ga(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5}, Lr/a;->ga(Ljava/lang/String;)V

    .line 34
    invoke-interface {v3}, Lr/j;->addNewPath()Lr/g;

    move-result-object v4

    .line 35
    sget-object v5, Lr/a0;->C8:Lr/a0$a;

    invoke-interface {v4, v5}, Lr/g;->Ew(Lr/a0$a;)V

    .line 36
    sget-object v6, Lq/e;->P7:Lq/e$a;

    invoke-interface {v4, v6}, Lr/g;->xA(Lq/e$a;)V

    const-string v6, "@9,0;@10,10800;@11,21600;@12,10800"

    .line 37
    invoke-interface {v4, v6}, Lr/g;->Wk(Ljava/lang/String;)V

    const-string v6, "270,180,90,0"

    .line 38
    invoke-interface {v4, v6}, Lr/g;->Bi(Ljava/lang/String;)V

    .line 39
    invoke-interface {v3}, Lr/j;->a2()Lr/l;

    move-result-object v4

    .line 40
    invoke-interface {v4, v5}, Lr/l;->x(Lr/a0$a;)V

    .line 41
    invoke-interface {v4, v5}, Lr/l;->Bz(Lr/a0$a;)V

    .line 42
    invoke-interface {v3}, Lr/j;->F4()Lr/f;

    move-result-object v4

    .line 43
    invoke-interface {v4}, Lr/f;->addNewH()Lr/e;
    ...
    .line 44
    invoke-interface {v4, v5}, Lr/e;->setPosition(Ljava/lang/String;)V

    const-string v5, "6629,14971"

    .line 45
    invoke-interface {v4, v5}, Lr/e;->pg(Ljava/lang/String;)V

    .line 46
    invoke-interface {v3}, Lr/j;->addNewLock()Lq/b;

    move-result-object v3

    .line 47
    sget-object v4, Lr/p;->p8:Lr/p$a;

    invoke-interface {v3, v4}, Lq/b;->G2(Lr/p$a;)V

    .line 48
    invoke-interface {v2}, Lr/d;->SA()Lr/i;
    ...
    invoke-interface {v3, v4}, Lr/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lr/i;->b0(Ljava/lang/String;)V

    const-string p2, "#_x0000_t136"

    .line 51
    invoke-interface {v3, p2}, Lr/i;->setType(Ljava/lang/String;)V
    ...
    .line 52
    invoke-interface {v3, p2}, Lr/i;->l(Ljava/lang/String;)V
    ...
    .line 53
    invoke-interface {v3, p2}, Lr/i;->M4(Ljava/lang/String;)V

    const-string p2, "black"

    .line 54
    invoke-interface {v3, p2}, Lr/i;->T2(Ljava/lang/String;)V

    .line 55
    sget-object p2, Lr/a0;->F8:Lr/a0$a;

    invoke-interface {v3, p2}, Lr/i;->g7(Lr/a0$a;)V

    .line 56
    invoke-interface {v3}, Lr/i;->a2()Lr/l;
    ...
    .line 57
    invoke-interface {p2, v3}, Lr/l;->l(Ljava/lang/String;)V

    .line 58
    invoke-interface {p2, p1}, Lr/l;->oF(Ljava/lang/String;)V
