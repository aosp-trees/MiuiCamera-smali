...
.method public printEscherRecord(Lorg/apache/poi/ddf/EscherRecord;)Ljava/lang/String;
    ...
    instance-of v3, v3, Lorg/apache/poi/hslf/record/TextCharsAtom;

    if-nez v3, :cond_1

    aget-object v3, p0, v2

    instance-of v3, v3, Lorg/apache/poi/hslf/record/TextBytesAtom;
...
.method public walkTree(II[Lorg/apache/poi/hslf/record/Record;)V
    ...
    :cond_2
    const-string v3, "org.apache.poi.hslf.record."
    ...
    .line 19
    iget-boolean v3, v0, Lorg/apache/poi/hslf/dev/SlideShowRecordDumper;->optEscher:Z

    if-eqz v3, :cond_4

    const-string v3, "PPDrawing"
    ...
    .line 24
    invoke-virtual {v3, v8, v9}, Lorg/apache/poi/ddf/DefaultEscherRecordFactory;->createRecord([BI)Lorg/apache/poi/ddf/EscherRecord;

    move-result-object v10

    .line 25
    invoke-virtual {v10, v8, v9, v3}, Lorg/apache/poi/ddf/EscherRecord;->fillFields([BILorg/apache/poi/ddf/EscherRecordFactory;)I
    ...
    .line 27
    iget-boolean v3, v0, Lorg/apache/poi/hslf/dev/SlideShowRecordDumper;->optVerbose:Z
    ...
    invoke-virtual {v0, v3, v8, v7}, Lorg/apache/poi/hslf/dev/SlideShowRecordDumper;->walkTree(II[Lorg/apache/poi/hslf/record/Record;)V
