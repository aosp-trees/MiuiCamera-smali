...
.method private buildSlidesAndNotes()V
    ...
    invoke-virtual {v4}, Lorg/apache/poi/hslf/record/SlideAtom;->getNotesID()I
    ...
    .line 56
    :cond_b
    iget-object v5, p0, Lorg/apache/poi/hslf/usermodel/SlideShow;->logger:Lorg/apache/poi/util/POILogger;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "Notes not found for noteId="
    ...
    invoke-virtual {v5, v6, v4}, Lorg/apache/poi/util/POILogger;->log(ILjava/lang/Object;)V
...
.method private findMostRecentCoreRecords()V
    ...
    instance-of v6, v6, Lorg/apache/poi/hslf/record/PositionDependentRecord;
...
.method private getCoreRecordForRefID(I)Lorg/apache/poi/hslf/record/Record;
    ...
    const-string v2, "We tried to look up a reference to a core record, but there was no core ID for reference ID "
...
.method public getFont(I)Lorg/apache/poi/hslf/model/PPFont;
    ...
    instance-of v1, v1, Lorg/apache/poi/hslf/record/FontEntityAtom;
...
.method public getNotesHeadersFooters()Lorg/apache/poi/hslf/model/HeadersFooters;
    ...
    instance-of v4, v4, Lorg/apache/poi/hslf/record/HeadersFootersContainer;
...
.method public removeSlide(I)Lorg/apache/poi/hslf/model/Slide;
    ...
    invoke-virtual {v10, v8}, Lorg/apache/poi/hslf/model/Slide;->setSlideNumber(I)V
    ...
    invoke-virtual {v8}, Lorg/apache/poi/hslf/record/SlideListWithText$SlideAtomsSet;->getSlideRecords()[Lorg/apache/poi/hslf/record/Record;
    ...
    invoke-virtual {v10}, Lorg/apache/poi/hslf/model/Slide;->getNotesSheet()Lorg/apache/poi/hslf/model/Notes;
    ...
    .line 23
    invoke-virtual {v2}, Lorg/apache/poi/hslf/model/Slide;->getSlideRecord()Lorg/apache/poi/hslf/record/Slide;
