...
# static fields
.field public static final DEFAULT_BULLET_CHAR:C = '\u25a0'


# instance fields
.field public _shape:Lorg/apache/poi/hslf/model/TextShape;
...
.method public getTextElements(FLjava/awt/font/FontRenderContext;)[Lorg/apache/poi/hslf/model/TextPainter$TextElement;
    ...
    .line 6
    invoke-interface {v3}, Ljava/text/AttributedCharacterIterator;->getBeginIndex()I
    ...
    .line 53
    :cond_17
    invoke-interface {v3, v5}, Ljava/text/AttributedCharacterIterator;->setIndex(I)C
...
.method public paint(Ljava/awt/Graphics2D;)V
    ...
    iget v5, v5, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->ascent:F

    aget-object v6, v1, v4

    iget v6, v6, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->descent:F
    ...
    iget-object v2, p0, Lorg/apache/poi/hslf/model/TextPainter;->_shape:Lorg/apache/poi/hslf/model/TextShape;

    invoke-virtual {v2}, Lorg/apache/poi/hslf/model/TextShape;->getMarginTop()F
    ...
    invoke-virtual {v2}, Lorg/apache/poi/hslf/model/TextShape;->getMarginBottom()F
    ...
    iget v2, v2, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->ascent:F
    ...
    invoke-direct {v2}, Ljava/awt/geom/Point2D$Double;-><init>()V

    .line 14
    iput-wide v5, v2, Ljava/awt/geom/Point2D$Double;->y:D
    ...
    iput-wide v8, v2, Ljava/awt/geom/Point2D$Double;->x:D
    ...
    iget-wide v8, v2, Ljava/awt/geom/Point2D$Double;->x:D
    ...
    iget-wide v9, v2, Ljava/awt/geom/Point2D$Double;->y:D
    ...
    invoke-virtual {p1, v4, v8, v2}, Ljava/awt/Graphics2D;->drawString(Ljava/text/AttributedCharacterIterator;FF)V

    .line 24
    :cond_7
    aget-object v2, v1, v3

    iget v2, v2, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->descent:F
