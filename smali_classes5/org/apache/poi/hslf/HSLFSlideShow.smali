...
.method private read([BI)[Lorg/apache/poi/hslf/record/Record;
    ...
    instance-of v3, v3, Lorg/apache/poi/hslf/record/PersistRecord;
...
.method private readCurrentUserStream()V
    ...
    const-string v4, "Error finding Current User Atom:\n"
...
.method public addPicture(Lorg/apache/poi/hslf/usermodel/PictureData;)I
    ...
    .line 7
    :cond_1
    invoke-virtual {p1, v0}, Lorg/apache/poi/hslf/usermodel/PictureData;->setOffset(I)V
...
.method public getEmbeddedObjects()[Lorg/apache/poi/hslf/usermodel/ObjectData;
    ...
    instance-of v3, v3, Lorg/apache/poi/hslf/record/ExOleObjStg;
...
.method public write(Ljava/io/OutputStream;Z)V
    ...
    instance-of v7, v7, Lorg/apache/poi/hslf/record/PositionDependentRecord;
