...
.method private setBlockProperties(Lorg/w3c/dom/Element;Lorg/apache/poi/hwpf/converter/FontReplacer$Triplet;)V
    ...
    invoke-interface {p1, p2, p0}, Lorg/w3c/dom/Element;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
...
.method public processCell(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/apache/poi/hssf/usermodel/HSSFCell;Lorg/w3c/dom/Element;IIF)Z
    ...
    const-string v6, "Unexpected cell cachedFormulaResultType ("
    ...
    invoke-virtual {v1, v7, v4}, Lorg/apache/poi/util/POILogger;->log(ILjava/lang/Object;)V
    ...
    invoke-virtual {v1, v4, v5, v2, v6}, Lorg/apache/poi/ss/usermodel/DataFormatter;->formatRawCellContents(DILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_a
    :goto_1
    invoke-static {v2}, Lorg/apache/poi/hssf/converter/AbstractExcelUtils;->isEmpty(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v2}, Lorg/apache/poi/hwpf/converter/FoDocumentFacade;->createText(Ljava/lang/String;)Lorg/w3c/dom/Text;
    ...
    const-string v5, "absolute-position"
    ...
    invoke-interface {v6, p5, p4}, Lorg/w3c/dom/Element;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 36
    invoke-interface {v6, p4, p5}, Lorg/w3c/dom/Element;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo p4, "wrap-option"
    ...
    invoke-virtual {p0, p1, p2, p3, v6}, Lorg/apache/poi/hssf/converter/ExcelToFoConverter;->processCellStyle(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/apache/poi/hssf/usermodel/HSSFCellStyle;Lorg/w3c/dom/Element;Lorg/w3c/dom/Element;)V
...
.method public processSheet(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;I)Z
    ...
    const-string/jumbo v3, "xsl-region-body"
