...
# instance fields
.field public commandDefinitions:[Lorg/apache/poi/hdgf/chunks/ChunkFactory$CommandDefinition;
...
.method public processCommands()V
    ...
    const-string v7, "Command offset "
    ...
    iget-object v5, p0, Lorg/apache/poi/hdgf/chunks/Chunk;->contents:[B

    invoke-static {v5, v4}, Lorg/apache/poi/util/LittleEndian;->getDouble([BI)D
    ...
    const-string v7, "Unexpected error processing command, ignoring and continuing. Command: "
