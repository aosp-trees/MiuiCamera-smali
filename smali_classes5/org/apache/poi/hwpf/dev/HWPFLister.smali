...
.method public dumpPapx(ZZ)V
    ...
    .line 25
    :cond_4
    const-class v1, Lorg/apache/poi/hwpf/usermodel/Paragraph;

    const-string v5, "newParagraph"

    new-array v6, v3, [Ljava/lang/Class;

    const-class v7, Lorg/apache/poi/hwpf/usermodel/Range;

    aput-object v7, v6, v2

    const-class v7, Lorg/apache/poi/hwpf/model/PAPX;
    ...
    .line 31
    iget-object v10, v0, Lorg/apache/poi/hwpf/dev/HWPFLister;->_doc:Lorg/apache/poi/hwpf/HWPFDocumentCore;
...
.method public dumpParagraphs(Z)V
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hwpf/HWPFDocumentCore;->getParagraphTable()Lorg/apache/poi/hwpf/model/PAPBinTable;

    move-result-object v3

    invoke-virtual {v3}, Lorg/apache/poi/hwpf/model/PAPBinTable;->getParagraphs()Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v4, v5}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V

    const-string v4, "** "

    .line 8
    invoke-virtual {p0, v1, v4}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpSprms(Lorg/apache/poi/hwpf/sprm/SprmIterator;Ljava/lang/String;)V
