...
.field public static final UNICODECHAR_NONBREAKING_HYPHEN:C = '\u2011'

.field public static final UNICODECHAR_NO_BREAK_SPACE:C = '\u00a0'

.field public static final UNICODECHAR_ZERO_WIDTH_SPACE:C = '\u200b'
...
.method private processOle2(Lorg/apache/poi/hwpf/HWPFDocument;Lorg/apache/poi/hwpf/usermodel/CharacterRun;Lorg/w3c/dom/Element;)Z
    ...
    const-string p3, "Referenced OLE2 object \'"

    const-string v0, "\' not found in ObjectPool"

    invoke-virtual {p0, p1, p3, p2, v0}, Lorg/apache/poi/util/POILogger;->log(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public processField(Lorg/apache/poi/hwpf/HWPFDocument;Lorg/apache/poi/hwpf/usermodel/Range;ILorg/apache/poi/hwpf/usermodel/Field;Lorg/w3c/dom/Element;)V
    ...
    .line 13
    new-instance v2, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$7;
    ...
    invoke-virtual {v7, v3}, Ljava/util/regex/Matcher;->end(I)I

    move-result v3

    add-int/2addr v10, v3

    invoke-direct {v2, p0, v9, v10, v6}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$7;-><init>(Lorg/apache/poi/hwpf/converter/AbstractWordConverter;IILorg/apache/poi/hwpf/usermodel/Range;)V
