...
.method private getByteBufferCount(Z)J
    ...
    sget-object p1, Ll/b/a/a/d;->a:Ll/b/a/a/d;
    ...
    sget-object p1, Ll/b/a/a/c;->a:Ll/b/a/a/c;
...
.method private updateMemory(Z)Ljava/util/function/IntConsumer;
    ...
    new-instance p1, Ll/b/a/a/b;

    invoke-direct {p1, p0}, Ll/b/a/a/b;-><init>(Ljava/util/concurrent/atomic/AtomicLong;)V
...
.method public release(Ljava/nio/ByteBuffer;)V
    ...
    .line 12
    :cond_3
    new-instance p1, Ll/b/a/a/a;

    invoke-direct {p1, p0}, Ll/b/a/a/a;-><init>(Lnet/majorkernelpanic/streaming/io/ArrayByteBufferPool;)V
