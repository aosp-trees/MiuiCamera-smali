...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lh/d3/x/w;)V
...
.method public constructor <init>(Lokio/BufferedSource;Z)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/Source;IIILh/d3/x/w;)V
...
.method private final readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p2, p0}, Lh/d3/x/l0;->C(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lh/h3/q;->z1(II)Lh/h3/k;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lh/h3/q;->e1(Lh/h3/i;I)Lh/h3/i;

    move-result-object p2

    invoke-virtual {p2}, Lh/h3/i;->c()I

    move-result v1

    invoke-virtual {p2}, Lh/h3/i;->d()I

    move-result v2

    invoke-virtual {p2}, Lh/h3/i;->e()I
