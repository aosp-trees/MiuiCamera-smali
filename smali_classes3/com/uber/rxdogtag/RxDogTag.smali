...
.method public static createException(Lcom/uber/rxdogtag/RxDogTag$Configuration;Ljava/lang/Throwable;Ljava/lang/Throwable;Ljava/lang/String;)Lio/reactivex/exceptions/OnErrorNotImplementedException;
    ...
    .line 16
    :cond_4
    sget-object p0, Lcom/uber/rxdogtag/l0;->a:Lcom/uber/rxdogtag/l0;
...
.method public static guardedDelegateCall(Lcom/uber/rxdogtag/RxDogTag$NonCheckingConsumer;Ljava/lang/Runnable;)V
    ...
    new-instance v2, Lcom/uber/rxdogtag/m0;

    invoke-direct {v2, v0, p0}, Lcom/uber/rxdogtag/m0;-><init>(Ljava/lang/Thread$UncaughtExceptionHandler;Lcom/uber/rxdogtag/RxDogTag$NonCheckingConsumer;)V
...
.method private static declared-synchronized installWithBuilder(Lcom/uber/rxdogtag/RxDogTag$Configuration;)V
    ...
    invoke-direct {v1, p0}, Lcom/uber/rxdogtag/j0;-><init>(Lcom/uber/rxdogtag/RxDogTag$Configuration;)V
    ...
    .line 5
    new-instance v1, Lcom/uber/rxdogtag/p0;

    invoke-direct {v1, p0}, Lcom/uber/rxdogtag/p0;-><init>(Lcom/uber/rxdogtag/RxDogTag$Configuration;)V
...
.method public static synthetic lambda$guardedDelegateCall$5(Ljava/lang/Thread$UncaughtExceptionHandler;Lcom/uber/rxdogtag/RxDogTag$NonCheckingConsumer;Ljava/lang/Thread;Ljava/lang/Throwable;)V
    .locals 2
...
.method public static synthetic lambda$installWithBuilder$0(Lcom/uber/rxdogtag/RxDogTag$Configuration;Lio/reactivex/Observable;Lio/reactivex/Observer;)Lio/reactivex/Observer;
    .locals 2
...
.method public static synthetic lambda$installWithBuilder$1(Lcom/uber/rxdogtag/RxDogTag$Configuration;Lio/reactivex/Flowable;Ln/e/c;)Ln/e/c;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    .line 2
    invoke-interface {v1, p1, p2}, Lcom/uber/rxdogtag/ObserverHandler;->handle(Lio/reactivex/Flowable;Ln/e/c;)Ln/e/c;
    ...
    invoke-direct {p1, p0, p2}, Lcom/uber/rxdogtag/DogTagSubscriber;-><init>(Lcom/uber/rxdogtag/RxDogTag$Configuration;Ln/e/c;)V
...
.method public static synthetic lambda$installWithBuilder$2(Lcom/uber/rxdogtag/RxDogTag$Configuration;Lio/reactivex/Single;Lio/reactivex/SingleObserver;)Lio/reactivex/SingleObserver;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic lambda$installWithBuilder$3(Lcom/uber/rxdogtag/RxDogTag$Configuration;Lio/reactivex/Maybe;Lio/reactivex/MaybeObserver;)Lio/reactivex/MaybeObserver;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic lambda$installWithBuilder$4(Lcom/uber/rxdogtag/RxDogTag$Configuration;Lio/reactivex/Completable;Lio/reactivex/CompletableObserver;)Lio/reactivex/CompletableObserver;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
