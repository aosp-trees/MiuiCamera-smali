.class public final synthetic Ld/j/b/h/f;
...
.method public synthetic constructor <init>(Lcom/google/firebase/concurrent/DelegatingScheduledExecutorService;Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)V
    ...
    iput-object p1, p0, Ld/j/b/h/f;->a:Lcom/google/firebase/concurrent/DelegatingScheduledExecutorService;

    iput-object p2, p0, Ld/j/b/h/f;->b:Ljava/lang/Runnable;

    iput-wide p3, p0, Ld/j/b/h/f;->c:J

    iput-wide p5, p0, Ld/j/b/h/f;->d:J

    iput-object p7, p0, Ld/j/b/h/f;->e:Ljava/util/concurrent/TimeUnit;
...
.method public final addCompleter(Lcom/google/firebase/concurrent/DelegatingScheduledFuture$Completer;)Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-object v0, p0, Ld/j/b/h/f;->a:Lcom/google/firebase/concurrent/DelegatingScheduledExecutorService;

    iget-object v1, p0, Ld/j/b/h/f;->b:Ljava/lang/Runnable;

    iget-wide v2, p0, Ld/j/b/h/f;->c:J

    iget-wide v4, p0, Ld/j/b/h/f;->d:J

    iget-object v6, p0, Ld/j/b/h/f;->e:Ljava/util/concurrent/TimeUnit;
