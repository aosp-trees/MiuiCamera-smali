.class public final synthetic Ld/j/b/h/h;
...
.method public synthetic constructor <init>(Lcom/google/firebase/concurrent/DelegatingScheduledExecutorService;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)V
    ...
    iput-object p1, p0, Ld/j/b/h/h;->a:Lcom/google/firebase/concurrent/DelegatingScheduledExecutorService;

    iput-object p2, p0, Ld/j/b/h/h;->b:Ljava/util/concurrent/Callable;

    iput-wide p3, p0, Ld/j/b/h/h;->c:J

    iput-object p5, p0, Ld/j/b/h/h;->d:Ljava/util/concurrent/TimeUnit;
...
.method public final addCompleter(Lcom/google/firebase/concurrent/DelegatingScheduledFuture$Completer;)Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-object v0, p0, Ld/j/b/h/h;->a:Lcom/google/firebase/concurrent/DelegatingScheduledExecutorService;

    iget-object v1, p0, Ld/j/b/h/h;->b:Ljava/util/concurrent/Callable;

    iget-wide v2, p0, Ld/j/b/h/h;->c:J

    iget-object v4, p0, Ld/j/b/h/h;->d:Ljava/util/concurrent/TimeUnit;
